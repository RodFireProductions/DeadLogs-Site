...
let siteName = "Comic Example";
let lang = "en"; // The language of your site. Example, en = english, fr = français (french), etc.
let siteUrl = "https://deadjournals.deadinsideartist.art/examples/absent_comic%20-%20light/index"; // You can just put the url of your site here, whether that be a subdomain or custom
...
let socials = [
    ...
    ['GitHub', 'https://github.com/RodFireProductions/DeadJournals-Website/tree/main/examples/absent_comic%20-%20light']
]

// Feel free to leave one of these values as 'null' if you don't wish to use them.
let author = {
    name: 'Rodrick',
    title: 'Your Nonbinary Demigod', // A job title or personal title, what ever defines you <3
